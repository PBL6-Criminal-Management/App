...
import { TextInput, View, ScrollView, RefreshControl, StatusBar, TouchableOpacity, Image } from 'react-native';
                ...
                <View style={styles.search}>
                    ...
                    <View style={styles.btnFilter}>
                        <TouchableOpacity
                            ...
                            >
                                <CustomText style={{ color: 'black' }}>Bộ lọc</CustomText>
                        </TouchableOpacity>
                        <Image style={styles.icon}
                    ...
                    >
                    {
                        historyList.map((item, index) => {
                            ...
                            if (index < Max_Image_Number)
                                return <WantedElement key={index} item={item} />
                        })
                    }
                    </ScrollView>
                </View>
